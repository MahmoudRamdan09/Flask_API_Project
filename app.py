...
curl -X POST -H "Content-Type: application/json" -d '{"Age": 21, "Gender": "male", "From": "هانوفيل", "To": "موقف", "Time": "From 6 AM To 9 AM", "IsRainy": "yes", "IsWeekend": "yes"}' http://localhost:5000/predict
